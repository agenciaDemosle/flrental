...
const categoryMap = {
  ...
  'CARGADOR FRONTAL': 25,
  'MOTONIVELADORA': 26,
  'TRACTOR DE CADENA': 27,
  'RETROEXCAVADORA': 28,
  'RODILLO COMPACTADOR': 29,
  'MINICARGADOR': 30,
  'MANIPULADOR TELESCÓPICO': 31,
  'MANIPULADOR TELESCÓPICO GIRATORIO': 31, // Misma categoría que manipulador telescópico
  'GRÚA HORQUILLA': 32,
...
async function assignCategories() {
  ...
  console.log(`Productos sin categoría asignada: ${skipped}`);
